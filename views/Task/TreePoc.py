...
class TreePoc(MyscanResource):
    ...
    poc_fields = {
        'label': fields.String,
        'children': fields.List(fields.Nested(children_fields))
    }
                    ...
                    if _['label'] and poc.parent.lower() == _['label'].lower():
                        ...
                        for child in _['children']:
                            if child['id'] == poc.id:
                                ...
                                break
                        if is_not_repeat:
                            data[index]['children'].append({'id': poc.id, 'label': poc.parent.lower() + '_' + poc.name.lower()})
